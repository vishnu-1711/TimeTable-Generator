  ...
  ?>
	...
	<div class="login">
		<form method="POST">
			...
			<input type="submit" value="Login" id="Loginbutton" name="submit1" style="width: 260px;height: 35px; background: red; color:black;  cursor: pointer; border-radius: 2px; 	font-family: 'Exo', sans-serif; font-size: 16px; font-weight: 400;padding: 6px; margin-top: 10px;">
